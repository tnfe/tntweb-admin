...
export const defaultModuleName = 'GeneralTable_Default';
...
export const createUseModel = () => {
  ...
  return makeUseModel<RootInfo, ModelDesc>(moduleName);
};

export const createUseModelWithSetup = () => {
  const moduleName = getModuleName();
  return makeUseModelWithSetup<RootInfo, ModelDesc>(moduleName);
};
